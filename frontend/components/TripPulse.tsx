    ...
    <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-0 mb-8 overflow-hidden">
        ...
        <div className="bg-gradient-to-r from-gray-900 to-gray-800 p-6 text-white flex justify-between items-center relative overflow-hidden">
            ...
            <div className="relative z-10 text-right">
                <div className="text-3xl font-bold text-booking-yellow">{data.trip_duration}</div>
        ...
        <div className="p-6">
            ...
            {/* Trip Vibe Tags - Safely accessing the safe 'interests' variable */}
            <div>
                ...
                <div className="flex flex-wrap gap-2">
                    ...
                    {interests.map((interest, idx) => (
                        <span key={idx} className="px-3 py-1 rounded-full bg-gray-50 text-gray-600 text-xs font-bold border border-gray-100 hover:bg-gray-100 transition-colors cursor-default">
                            #{interest}
                        </span>
                    ))}
                </div>
